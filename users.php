...
if($_POST['setid'] == $_SESSION['setid'])
{
  ...
  {	 
		...
		else
		{
			...
			{
				$res =  "<font color='green'><center><center>One record is added...</font>";
				$resi=1;
			}
		}
  }
...
<h2 style="font-size:35px; width: 100%;"> ADD Teacher &nbsp;/ Administrator</h2>
    </div>
    <div class="clr"></div>
...
<center>
<table  class="content-table" width="430" border="1">
		   <?php
if($resi==1)
{
...
?>
  ...
  <tr>
	...
	<td><select name="designation" id="designation">
		...
		<?php
		$arr = array("Faculty","H.O.D","Principle","Admin Office member","Advisor","Developer");
		foreach($arr as $val)
		{
			if($val == $rs['designation'])
			{
...
?>
  ...
  <thead>
  <tr>
    <th colspan="2" scope="row" style="text-align:center;" ><input type="submit" style="height:40px; width:40%; color:black; text-align:center;" name="submit" id="submit" value="Submit" /></th>
  </tr>
  </thead>
</table>
</form>
